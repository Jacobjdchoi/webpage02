<template>
  <div id="app">
    <navigation-bar>
        <router-view slot="mobile"/>
        <router-view slot="browser"/>
    </navigation-bar>
  </div>
</template>
...
<style lang="scss">
$browser-center-contents-width: 75vw;
$page-title-height: 12vh;
$slider-color-home: #820800;
